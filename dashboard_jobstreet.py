...
st.sidebar.image("D:\Pictures\LOGO\streamlit-logo.png", use_container_width=True)

st.sidebar.title("Menu")

page = st.sidebar.selectbox("", 
                        ("Home", "Dashboard", "Machine Learning"))
...
if page == "Home":
    ...
    st.sidebar.markdown("**Nabila Valinka**")
    st.sidebar.markdown(
        """
        Visit my profile:
    ...
    st.sidebar.markdown("Thank you for using this dashboard! 🙏")
...
####################### DASHBOARD #######################
    ...
    if filtered_data.empty:
        st.warning("There is no data for the selected province and classification.")
        st.stop()
